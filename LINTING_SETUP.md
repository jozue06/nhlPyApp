...
- **Config**: `frontend/.eslintrc.js` - React-specific rules, Prettier integration, **2-space indentation rules**, **double quote enforcement**
- **Usage**: `cd frontend && npm run lint` or `npm run lint:fix`

### Prettier (Code Formatter)

- **Purpose**: Automatically formats JavaScript/React code with **2-space indentation**
- **Config**: `frontend/.prettierrc` - **double quotes**, semicolons, 80 char width, **tabWidth: 2**, **arrowParens: always**
- **Usage**: `cd frontend && npm run format` or `npm run format:check`
...
```bash
# Python (4 spaces)
black backend/*.py                    # Format Python code
isort backend/*.py                    # Sort Python imports
flake8 backend/*.py                   # Lint Python code
mypy backend/*.py                     # Type check Python code
...
- `frontend/.eslintrc.js` - ESLint rules with 2-space indentation enforcement
- `frontend/.prettierrc` - Prettier formatting with `tabWidth: 2`
- `frontend/.eslintignore` - Files/directories to exclude from ESLint
- `frontend/.prettierignore` - Files/directories to exclude from Prettier
...
3. Use `./fix-python.sh` and `cd frontend && npm run format` to auto-fix formatting
...
- Modify JavaScript formatting in `frontend/.prettierrc` (including `tabWidth`)
- Add/remove linting rules in `.flake8` and `frontend/.eslintrc.js`
